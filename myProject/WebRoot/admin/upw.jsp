...
<html>
  ...
  <body>
  	...
  	<div id="div1">
   		<form id="form1" action="${pageContext.request.contextPath }/admin_updatePWSX.action?aid=<s:property value="#session.admin.aid"/>" method="post" target="mainFrame" onsubmit="return checkForm('<s:property value="#session.admin.password" />')">
   			<table>
   				<tr>
   				...
   				<tr>
   					...
   					<td><input id="npw" name="newPW" type="password" onblur="checkNPW()"/></td>
