  	  ...
  	  <div id="div2">
   		<table border="0px" cellspacing="0px">
   			...
   			<tr>
				...
				<td>
				<a href="${pageContext.request.contextPath }/admin_ckAnswerSituation.action?trid=<s:property value="#tr.trid"/>">答题情况</a>
				|<a href="${pageContext.request.contextPath }/admin_deleteTestRecord.action?trid=<s:property value="#tr.trid"/>">删除</a>
				</td>
   			</tr>
   			</s:iterator>
   		</table>
