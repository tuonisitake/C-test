...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function checkForm(){
			if(checkQcontent() && checkQanswer() && checkQdifficulty() && checkOword() && checkQanalysis()){
				return true;
			}else{
				return false;
			}
  ...
  <body>
    ...
    <div id="div1">
    	<div id="div2">
    		<form id="form1" action="${pageContext.request.contextPath }/question_addpdq.action?qtid=2&aid=<s:property value="#session.admin.aid" />" method="post" target="mainFrame" onsubmit="return checkForm()">
    			<table>
    				<tr>
