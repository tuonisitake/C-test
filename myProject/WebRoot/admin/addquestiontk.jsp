...
<html>
  ...
  <body>
    ...
    <div id="div1">
    	<div id="div2">
    		<form id="form1" action="${pageContext.request.contextPath }/question_addtkq.action?qtid=3&aid=<s:property value="#session.admin.aid" />" method="post" target="mainFrame" onsubmit="return checkForm()">
    			<table>
    				<tr>
