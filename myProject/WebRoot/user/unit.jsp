...
<html>
  ...
  <body>
    ...
    <div style="text-align:center">
      <form action="${pageContext.request.contextPath }/test_unitTest.action?" method="post" target="_blank">

      <select id="qscope" name="qscope">
      <option selected="selected" value="第一单元">第一单元</option>
      <option value="第二单元">第二单元</option>
      <option value="第三单元">第三单元</option>
      <option value="第四单元">第四单元</option>
      <option value="第五单元">第五单元</option>
      </select>
      <input type="submit" value="单元测试" class="ibtn">
